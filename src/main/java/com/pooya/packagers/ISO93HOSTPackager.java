 ...
 * @see ISOComponent
 */
public class ISO93HOSTPackager extends ISOBasePackager {
    ...
    /* 044 */new IFB_BLLLBINARY(999, "Additional response data"),
